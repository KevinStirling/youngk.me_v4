...
date = 2026-03-08T18:29:47-04:00
draft = false
+++
...
>_Live mlb scores in the terminal_

 Late last year, I was looking for an excuse to use [Charmbracelet's](https://charm.land/) popular ecosystem for building TUI's, and found my excuse while watching the lead up to the 2025 MLB post season.
...
![scorebug](/images/projects/sb_preview_sm.png "scorebug") 
...
Fast forward after several quake & source engine history lessons, source code deep-dives, obsessing over source engine modding / map making, and creating an automated set of [shell scripts and docker-compose](https://github.com/KevinStirling/one-point-six) for running cs 1.6 servers later... I return to Radix with my new goals!
